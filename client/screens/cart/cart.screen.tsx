...
export default function CartScreen() {
  ...
  // Conditional Stripe hook usage
  let stripe = null;
  let initPaymentSheet = null;
  let presentPaymentSheet = null;
  
  if (Platform.OS !== 'web') {
    try {
      stripe = require("@stripe/stripe-react-native").useStripe();
      if (stripe) {
  ...
  const handlePayment = async () => {
    ...
    if (Platform.OS === 'web') {
      alert('Payment is not supported on web platform. Please use the mobile app.');
      return;
    }
